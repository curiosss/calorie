...
class HistoryWaterView extends StatefulWidget {
  const HistoryWaterView(
  ...
  @override
  _HistoryWaterViewState createState() => _HistoryWaterViewState();
}

class _HistoryWaterViewState extends State<HistoryWaterView>
